...
- `ops/mcp/jira-local.sh`: helyi Jira MCP launcher a repohoz kotott stdio inditashoz
...
- Helyi futtatasnal az `ops/ai/mcps.yaml` a `ops/mcp/jira-local.sh` launchert hasznalja.
